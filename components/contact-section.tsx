    ...
    <section id="contact" className="py-20 px-4 bg-muted/30">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">Let's Work Together</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:Rishabhjain27082004@gmail.com"
                      className="text-muted-foreground hover:text-primary transition-colors"
                    >
                      Rishabhjain27082004@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+918955226422" className="text-muted-foreground hover:text-primary transition-colors">
                      +91 8955226422
                    </a>
                  </div>
                </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="font-heading">Send me a message</CardTitle>
            </CardHeader>
            <CardContent>
